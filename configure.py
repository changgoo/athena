...
if args['cxx'] == 'icpx-debug':
    ...
    makefile_options['PREPROCESSOR_FLAGS'] = ''
    makefile_options['COMPILER_FLAGS'] = (
      '-O3 -std=c++11 -xhost -qopenmp-simd'
    )
    makefile_options['LINKER_FLAGS'] = ''
    makefile_options['LIBRARY_FLAGS'] = ''
if args['cxx'] == 'icpc':
...
if args['debug']:
    ...
    if (args['cxx'] == 'g++' or args['cxx'] == 'g++-simd'
            or args['cxx'] == 'icpx' or args['cxx'] == 'icpx-debug'
...
if args['omp']:
    ...
    if args['cxx'] == 'icpc' or args['cxx'] == 'icpc-debug' or \
            args['cxx'] == 'icpc-phi' or \
            args['cxx'] == 'icpx' or args['cxx'] == 'icpx-debug':
