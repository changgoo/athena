...
public:
  HydroBoundaryVariable(MeshBlock *pmb, AthenaArray<Real> *var_hydro,
  ...
  void SwapHydroQuantity(AthenaArray<Real> &var_hydro,
                         HydroBoundaryQuantity hydro_type);
...
private:
  ...
  //! Hydro is a unique cell-centered variable because of the relationship
  //! between HydroBoundaryQuantity::cons u and HydroBoundaryQuantity::prim w.
