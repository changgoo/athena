...
//========================================================================================
//! \file outflow_cc.cpp
//! \brief implementation of outflow BCs in each dimension for cell-centered
//! AthenaArray
...
void CellCenteredBoundaryVariable::OutflowInnerX1(Real time, Real dt, int il,
...
void CellCenteredBoundaryVariable::OutflowOuterX1(Real time, Real dt, int iu,
                                                  int jl, int ju, int kl,
                                                  int ku, int ngh) {
  for (int n = 0; n <= nu_; ++n) {
    for (int k = kl; k <= ku; ++k) {
...
void CellCenteredBoundaryVariable::OutflowInnerX2(Real time, Real dt, int il,
...
void CellCenteredBoundaryVariable::OutflowOuterX2(Real time, Real dt, int il,
...
void CellCenteredBoundaryVariable::OutflowInnerX3(Real time, Real dt, int il,
...
void CellCenteredBoundaryVariable::OutflowOuterX3(Real time, Real dt, int il,
                                                  int iu, int jl, int ju,
                                                  int ku, int ngh) {
  for (int n = 0; n <= nu_; ++n) {
    for (int k = 1; k <= ngh; ++k) {
