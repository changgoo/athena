...
void FaceCenteredBoundaryVariable::OutflowInnerX1(Real time, Real dt, int il,
...
void FaceCenteredBoundaryVariable::OutflowOuterX1(Real time, Real dt, int iu,
                                                  int jl, int ju, int kl,
                                                  int ku, int ngh) {
  // copy face-centered magnetic fields into ghost zones
  for (int k = kl; k <= ku; ++k) {
...
void FaceCenteredBoundaryVariable::OutflowInnerX2(Real time, Real dt, int il,
...
void FaceCenteredBoundaryVariable::OutflowOuterX2(Real time, Real dt, int il,
...
void FaceCenteredBoundaryVariable::OutflowInnerX3(Real time, Real dt, int il,
...
void FaceCenteredBoundaryVariable::OutflowOuterX3(Real time, Real dt, int il,
                                                  int iu, int jl, int ju,
                                                  int ku, int ngh) {
  // copy face-centered magnetic fields into ghost zones
  for (int k = 1; k <= ngh; ++k) {
