...
public:
  ...
  double tremap1[10], tremap2[10], tremap3[10],
      tremap4[10]; // per-remap time for each trial
  ...
  void tune(int, int, int, int, int, int, int, int, int, int, int, int, int,
            int, int, int, int &, int &, int &, int, int, double, int);
...
private:
  ...
  void tune_trial(FFT_SCALAR *, int, int, int, double &, double &, double &,
