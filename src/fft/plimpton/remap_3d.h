...
struct remap_plan_3d {
  ...
  void (*pack)(double *, double *,
               struct pack_plan_3d *); /* which pack function to use */
  void (*unpack)(double *, double *,
                 struct pack_plan_3d *); /* which unpack function to use */
...
struct remap_plan_3d *remap_3d_create_plan(MPI_Comm, int, int, int, int, int,
                                           int, int, int, int, int, int, int,
                                           int, int, int, int);
void remap_3d_destroy_plan(struct remap_plan_3d *);
int remap_3d_collide(struct extent_3d *, struct extent_3d *,
                     struct extent_3d *);
