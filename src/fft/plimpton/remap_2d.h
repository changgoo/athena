...
struct remap_plan_2d {
  ...
  void (*pack)(double *, double *,
               struct pack_plan_2d *); /* which pack function to use */
  void (*unpack)(double *, double *,
                 struct pack_plan_2d *); /* which unpack function to use */
...
struct remap_plan_2d *remap_2d_create_plan(MPI_Comm, int, int, int, int, int,
                                           int, int, int, int, int, int, int);
void remap_2d_destroy_plan(struct remap_plan_2d *);
int remap_2d_collide(struct extent_2d *, struct extent_2d *,
                     struct extent_2d *);
