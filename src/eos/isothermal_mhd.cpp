...
EquationOfState::EquationOfState(MeshBlock *pmb, ParameterInput *pin)
    : pmy_block_(pmb), neighbor_flooring_{pin->GetOrAddBoolean(
                           "hydro", "neighbor_flooring", false)},
      iso_sound_speed_{
          pin->GetReal("hydro", "iso_sound_speed")}, // error if missing!
      density_floor_{
...
//! Note the formula for (C_f)^2 is positive definite, so this func never
//! returns a NaN
