...
public:
  ...
  int self_consistent_flag; // to enable the self-consistent calculation of
                            // sigma
  ...
  Real perp_to_par_diff; // ratio between the scattering coefficient in the
                         // direction perpendicular to the magntic field and the
                         // scattering coefficient in the direction parallel to
                         // the magntic field
  ...
  AthenaArray<Real>
      b_angle; // sin\theta,cos\theta,sin\phi,cos\phi of B direction
...
void DefaultTemperature(Units *punit, Real rho, Real Press, Real &Temp,
                        Real &mu, Real &muH);
