...
//  \brief Problem Generator for the Orszag-Tang test.  The initial conditions
//  are constructed assuming the domain extends over [-0.5x0.5, -0.5x0.5], so
//  that exact symmetry can be enforced across x=0 and y=0.
//========================================================================================
