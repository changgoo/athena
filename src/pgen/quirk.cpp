...
//! Physically such a perturbation should not grow but with high resolution
//! schemes such as Roe/HLLC/HLLD often suffer from unphysical amplification of
//! the perturbation at strong shocks. This problem is well known as the
//! Carbuncle phenomenon. To suppress it, use the new LHLLC/LHLLD solvers
...
//! \brief Calculate the difference of the post-shock entropy in odd and even
//! rows
//========================================================================================
...
void Mesh::UserWorkAfterLoop(ParameterInput *pin) {
  if (Globals::my_rank == 0) {
    ...
    if (deltas > 0.05)
      std::cout
          << "The scheme suffers from the Carbuncle phenomenon : delta s = "
          << deltas << std::endl;
    else
      std::cout << "The scheme looks stable against the Carbuncle phenomenon : "
                   "delta s = "
                << deltas << std::endl;
