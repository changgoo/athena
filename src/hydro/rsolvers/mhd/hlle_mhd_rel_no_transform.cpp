...
//   Harm cf. HLLENonTransforming() in hlle_mhd_rel.cpp and hlld_rel.cpp
...
#pragma omp simd
  for (int i = il; i <= iu; ++i) {
    ...
    const Real &g_00 = g_(I00, i), &g_01 = g_(I01, i), &g_02 = g_(I02, i),
               &g_03 = g_(I03, i), &g_10 = g_(I01, i), &g_11 = g_(I11, i),
               &g_12 = g_(I12, i), &g_13 = g_(I13, i), &g_20 = g_(I02, i),
               &g_21 = g_(I12, i), &g_22 = g_(I22, i), &g_23 = g_(I23, i),
               &g_30 = g_(I03, i), &g_31 = g_(I13, i), &g_32 = g_(I23, i),
               &g_33 = g_(I33, i);
    const Real &g00 = gi_(I00, i), &g01 = gi_(I01, i), &g02 = gi_(I02, i),
               &g03 = gi_(I03, i), &g10 = gi_(I01, i), &g11 = gi_(I11, i),
               &g12 = gi_(I12, i), &g13 = gi_(I13, i), &g20 = gi_(I02, i),
               &g21 = gi_(I12, i), &g22 = gi_(I22, i), &g23 = gi_(I23, i),
               &g30 = gi_(I03, i), &g31 = gi_(I13, i), &g32 = gi_(I23, i),
               &g33 = gi_(I33, i);
    ...
    pmy_block->peos->FastMagnetosonicSpeedsGR(wgas_l, pgas_l, ucon_l[0],
                                              ucon_l[ivx], b_sq_l, g00, g0i,
                                              gii, &lambda_p_l, &lambda_m_l);

    // Calculate wavespeeds in right state
    Real lambda_p_r, lambda_m_r;
    Real wgas_r = rho_r + gamma_adi / (gamma_adi - 1.0) * pgas_r;
    pmy_block->peos->FastMagnetosonicSpeedsGR(wgas_r, pgas_r, ucon_r[0],
                                              ucon_r[ivx], b_sq_r, g00, g0i,
    ...
    wct(k, j, i) = GetWeightForCT(flux_interface[IDN], prim_l(IDN, i),
