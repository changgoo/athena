...
void Hydro::RiemannSolver(const int k, const int j, const int il, const int iu,
  ...
  if (GENERAL_RELATIVITY && ivx == IVY && pmy_block->pcoord->IsPole(j)) {
    ...
    HLLETransforming(pmy_block, k, j, il, iu, ivx, g_, gi_, prim_l, prim_r,
                     cons_, flux);
  }
  return;
}
...
namespace {
//----------------------------------------------------------------------------------------
//! \fn void HLLETransforming(MeshBlock *pmb, const int k, const int j, const
//! int il,
...
//----------------------------------------------------------------------------------------
//! \fn void HLLENonTransforming(MeshBlock *pmb, const int k, const int j, const
//! int il,
//!                         const int iu, AthenaArray<Real> &g,
//!                         AthenaArray<Real> &gi, AthenaArray<Real> &prim_l,
//!                         AthenaArray<Real> &prim_r, AthenaArray<Real> &flux)
