...
//========================================================================================
//! \file llf_rel.cpp
//! \brief Implements local Lax-Friedrichs Riemann solver for relativistic
//! hydrodynamics.
...
//!  - implements LLF algorithm similar to that of fluxcalc() in step_ch.c in
//!  Harm
...
void Hydro::RiemannSolver(const int k, const int j, const int il, const int iu,
  ...
  if (GENERAL_RELATIVITY && ivx == IVY && pmy_block->pcoord->IsPole(j)) {
    ...
    LLFTransforming(pmy_block, k, j, il, iu, ivx, g_, gi_, prim_l, prim_r,
                    cons_, flux);
  }
  return;
}
...
namespace {
//----------------------------------------------------------------------------------------
//! \fn void LLFTransforming(MeshBlock *pmb, const int k, const int j,
...
//! \brief Frame-transforming LLF implementation
//!
//! Inputs:
...
//----------------------------------------------------------------------------------------
//! \fn void LLFNonTransforming(MeshBlock *pmb, const int k, const int j,
//!                         const int il, const int iu,
//!                         AthenaArray<Real> &g, AthenaArray<Real> &gi,
//!                         AthenaArray<Real> &prim_l, AthenaArray<Real>
//!                         &prim_r, AthenaArray<Real> &flux)
//! \brief Non-frame-transforming LLF implementation
//!
//! Inputs:
//!  - pmb: pointer to MeshBlock object
//!  - k,j: x3- and x2-indices
...
//!  - implements LLF algorithm similar to that of fluxcalc() in step_ch.c in
//!  Harm
//!  - derived from RiemannSolver() in llf_rel_no_transform.cpp assuming ivx =
//!  IVY
