...
//!
//! Contains data and functions that implement physical (not coordinate) source
//! terms
...
public:
  ...
  // functions
  void AddHydroSourceTerms(const Real time, const Real dt,
                           const AthenaArray<Real> *flx,
                           const AthenaArray<Real> &prim,
                           const AthenaArray<Real> &prim_scalar,
                           const AthenaArray<Real> &b, AthenaArray<Real> &cons,
                           AthenaArray<Real> &cons_scalar);
  void PointMass(const Real dt, const AthenaArray<Real> *flx,
...
private:
  ...
  int flag_shearing_source_; // 1=orbital advection, 2=shearing box, 3=rotating
                             // system
};
