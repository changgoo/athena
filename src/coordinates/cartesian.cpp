...
//========================================================================================
//! \file cartesian.cpp
//! \brief implements functions for Cartesian (x-y-z) coordinates in a derived
//! class of the Coordinates abstract base class.
...
void Cartesian::CartesianToMeshCoords(Real x, Real y, Real z, Real &x1,
...
void Cartesian::MeshCoordsToCartesian(Real x1, Real x2, Real x3, Real &x,
                                      Real &y, Real &z) const {
  x = x1;
  y = x2;
  z = x3;
...
void Cartesian::CartesianToMeshCoordsVector(Real x, Real y, Real z, Real vx,
...
void Cartesian::MeshCoordsToCartesianVector(Real x1, Real x2, Real x3, Real vx1,
