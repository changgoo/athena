...
//========================================================================================
//! \file minkowski.cpp
//! \brief implements functions for Minkowski (flat) spacetime and Cartesian
//! (t,x,y,z) coordinates in a derived class of the Coordinates abstract base
//! class.
//!
//! Notes:
//!  - coordinates: t, x, y, z
...
void Minkowski::Face1Metric(const int k, const int j, const int il,
...
void Minkowski::Face2Metric(const int k, const int j, const int il,
                            const int iu, AthenaArray<Real> &g,
                            AthenaArray<Real> &g_inv) {
#pragma omp simd
  for (int i = il; i <= iu; ++i) {
...
void Minkowski::Face3Metric(const int k, const int j, const int il,
                            const int iu, AthenaArray<Real> &g,
                            AthenaArray<Real> &g_inv) {
#pragma omp simd
  for (int i = il; i <= iu; ++i) {
...
void Minkowski::PrimToLocal1(const int k, const int j, const int il,
...
void Minkowski::PrimToLocal2(const int k, const int j, const int il,
...
void Minkowski::PrimToLocal3(const int k, const int j, const int il,
...
void Minkowski::FluxToGlobal1(const int k, const int j, const int il,
...
void Minkowski::FluxToGlobal2(const int k, const int j, const int il,
                              const int iu, const AthenaArray<Real> &cons,
                              const AthenaArray<Real> &bbx,
                              AthenaArray<Real> &flux, AthenaArray<Real> &ey,
                              AthenaArray<Real> &ez) {
...
void Minkowski::FluxToGlobal3(const int k, const int j, const int il,
                              const int iu, const AthenaArray<Real> &cons,
                              const AthenaArray<Real> &bbx,
                              AthenaArray<Real> &flux, AthenaArray<Real> &ey,
                              AthenaArray<Real> &ez) {
...
void Minkowski::RaiseVectorCell(Real a_0, Real a_1, Real a_2, Real a_3, int k,
...
void Minkowski::LowerVectorCell(Real a0, Real a1, Real a2, Real a3, int k,
