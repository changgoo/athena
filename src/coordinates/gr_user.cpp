...
//========================================================================================
//! \file gr_user.cpp
//!  \brief Used for arbitrary stationary coordinates in general relativity,
//!  with all functions evaluated numerically based on the metric.
//!
...
void CalculateTransformation(const AthenaArray<Real> &g,
                             const AthenaArray<Real> &g_inv, int face,
                             AthenaArray<Real> &transformation);
} // namespace
...
void GRUser::AddCoordTermsDivergence(const Real dt,
...
#pragma omp simd
      for (int i = is; i <= ie; ++i) {
        ...
        Real uu_sq = g_11 * uu1 * uu1 + 2.0 * g_12 * uu1 * uu2 +
                     2.0 * g_13 * uu1 * uu3 + g_22 * uu2 * uu2 +
                     2.0 * g_23 * uu2 * uu3 + g_33 * uu3 * uu3;
...
void GRUser::PrimToLocal1(const int k, const int j, const int il, const int iu,
                          const AthenaArray<Real> &bb1,
  ...
  for (int i = il; i <= iu; ++i) {
    ...
    if (MAGNETIC_FIELDS_ENABLED) {
      ...
      Real tmp = g_11 * uu1_l * uu1_l + 2.0 * g_12 * uu1_l * uu2_l +
                 2.0 * g_13 * uu1_l * uu3_l + g_22 * uu2_l * uu2_l +
                 2.0 * g_23 * uu2_l * uu3_l + g_33 * uu3_l * uu3_l;
      ...
      tmp = g_11 * uu1_r * uu1_r + 2.0 * g_12 * uu1_r * uu2_r +
            2.0 * g_13 * uu1_r * uu3_r + g_22 * uu2_r * uu2_r +
            2.0 * g_23 * uu2_r * uu3_r + g_33 * uu3_r * uu3_r;
      ...
      Real b0_l =
          g_10 * bb1_l * u0_l + g_11 * bb1_l * u1_l + g_12 * bb1_l * u2_l +
          g_13 * bb1_l * u3_l + g_20 * bb2_l * u0_l + g_21 * bb2_l * u1_l +
          g_22 * bb2_l * u2_l + g_23 * bb2_l * u3_l + g_30 * bb3_l * u0_l +
          g_31 * bb3_l * u1_l + g_32 * bb3_l * u2_l + g_33 * bb3_l * u3_l;
      Real b1_l = (bb1_l + b0_l * u1_l) / u0_l;
      Real b2_l = (bb2_l + b0_l * u2_l) / u0_l;
      Real b3_l = (bb3_l + b0_l * u3_l) / u0_l;
      Real b0_r =
          g_10 * bb1_r * u0_r + g_11 * bb1_r * u1_r + g_12 * bb1_r * u2_r +
          g_13 * bb1_r * u3_r + g_20 * bb2_r * u0_r + g_21 * bb2_r * u1_r +
          g_22 * bb2_r * u2_r + g_23 * bb2_r * u3_r + g_30 * bb3_r * u0_r +
          g_31 * bb3_r * u1_r + g_32 * bb3_r * u2_r + g_33 * bb3_r * u3_r;
...
void GRUser::PrimToLocal2(const int k, const int j, const int il, const int iu,
                          const AthenaArray<Real> &bb2,
                          AthenaArray<Real> &prim_l, AthenaArray<Real> &prim_r,
                          AthenaArray<Real> &bbx) {
  // Go through 1D block of cells
#pragma omp simd
...
void GRUser::PrimToLocal3(const int k, const int j, const int il, const int iu,
                          const AthenaArray<Real> &bb3,
                          AthenaArray<Real> &prim_l, AthenaArray<Real> &prim_r,
                          AthenaArray<Real> &bbx) {
  // Go through 1D block of cells
#pragma omp simd
...
void GRUser::FluxToGlobal1(const int k, const int j, const int il, const int iu,
...
#pragma omp simd
  for (int i = il; i <= iu; ++i) {
    ...
    Real t11 =
        m1_tm * (m1_tm * ttt + m1_x * ttx) + m1_x * (m1_tm * txt + m1_x * txx);
...
void GRUser::FluxToGlobal2(const int k, const int j, const int il, const int iu,
                           const AthenaArray<Real> &cons,
                           const AthenaArray<Real> &bbx,
                           AthenaArray<Real> &flux, AthenaArray<Real> &ey,
                           AthenaArray<Real> &ez) {
...
void GRUser::FluxToGlobal3(const int k, const int j, const int il, const int iu,
                           const AthenaArray<Real> &cons,
                           const AthenaArray<Real> &bbx,
                           AthenaArray<Real> &flux, AthenaArray<Real> &ey,
                           AthenaArray<Real> &ez) {
...
#pragma omp simd
  for (int i = il; i <= iu; ++i) {
    ...
    // Transform stress-energy tensor
    Real t30 = m3_tm * (m0_tm * ttt) + m3_x * (m0_tm * txt);
    ...
    Real t33 =
        m3_tm * (m3_tm * ttt + m3_x * ttx) + m3_x * (m3_tm * txt + m3_x * txx);
...
void GRUser::RaiseVectorCell(Real a_0, Real a_1, Real a_2, Real a_3, int k,
...
void GRUser::LowerVectorCell(Real a0, Real a1, Real a2, Real a3, int k, int j,
