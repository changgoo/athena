...
//! \brief implements functions for Schwarzschild spacetime and spherical
...
Schwarzschild::Schwarzschild(MeshBlock *pmb, ParameterInput *pin, bool flag)
  ...
  // Allocate and compute arrays for intermediate geometric quantities always
  // needed
...
void Schwarzschild::Edge1Length(const int k, const int j, const int il,
...
void Schwarzschild::Edge2Length(const int k, const int j, const int il,
                                const int iu, AthenaArray<Real> &lengths) {
...
void Schwarzschild::Edge3Length(const int k, const int j, const int il,
                                const int iu, AthenaArray<Real> &lengths) {
...
void Schwarzschild::CenterWidth1(const int k, const int j, const int il,
...
void Schwarzschild::CenterWidth2(const int k, const int j, const int il,
...
void Schwarzschild::CenterWidth3(const int k, const int j, const int il,
...
void Schwarzschild::Face1Area(const int k, const int j, const int il,
                              const int iu, AthenaArray<Real> &areas) {
...
void Schwarzschild::Face2Area(const int k, const int j, const int il,
                              const int iu, AthenaArray<Real> &areas) {
...
void Schwarzschild::Face3Area(const int k, const int j, const int il,
                              const int iu, AthenaArray<Real> &areas) {
...
void Schwarzschild::CellVolume(const int k, const int j, const int il,
...
void Schwarzschild::AddCoordTermsDivergence(const Real dt,
...
#pragma omp simd
      for (int i = pmy_block->is; i <= pmy_block->ie; ++i) {
        ...
        Real s_1 = 0.5 * (d1_g_00 * tt00 + d1_g_11 * tt11 + d1_g_22 * tt22 +
                          d1_g_33 * tt33);
...
void Schwarzschild::CellMetric(const int k, const int j, const int il,
...
void Schwarzschild::Face1Metric(const int k, const int j, const int il,
                                const int iu, AthenaArray<Real> &g,
                                AthenaArray<Real> &g_inv) {
  // Extract geometric quantities that do not depend on r
...
void Schwarzschild::Face2Metric(const int k, const int j, const int il,
                                const int iu, AthenaArray<Real> &g,
                                AthenaArray<Real> &g_inv) {
  // Extract geometric quantities that do not depend on r
...
void Schwarzschild::Face3Metric(const int k, const int j, const int il,
                                const int iu, AthenaArray<Real> &g,
                                AthenaArray<Real> &g_inv) {
  // Extract geometric quantities that do not depend on r
...
void Schwarzschild::PrimToLocal1(const int k, const int j, const int il,
...
#pragma omp simd
  for (int i = il; i <= iu; ++i) {
    ...
    if (MAGNETIC_FIELDS_ENABLED) {
      ...
      Real tmp =
          g_11 * uu1_l * uu1_l + g_22 * uu2_l * uu2_l + g_33 * uu3_l * uu3_l;
      ...
      Real b0_l =
          g_11 * bb1_l * u1_l + g_22 * bb2_l * u2_l + g_33 * bb3_l * u3_l;
      Real b1_l = (bb1_l + b0_l * u1_l) / u0_l;
      Real b2_l = (bb2_l + b0_l * u2_l) / u0_l;
      Real b3_l = (bb3_l + b0_l * u3_l) / u0_l;
      Real b0_r =
          g_11 * bb1_r * u1_r + g_22 * bb2_r * u2_r + g_33 * bb3_r * u3_r;
...
void Schwarzschild::PrimToLocal2(const int k, const int j, const int il,
...
void Schwarzschild::PrimToLocal3(const int k, const int j, const int il,
...
//   bbx: 1D array of longitudinal magnetic fields, in local coordinates (not
//   used) flux: 3D array of hydrodynamical fluxes, using local coordinates
...
void Schwarzschild::FluxToGlobal1(const int k, const int j, const int il,
...
void Schwarzschild::FluxToGlobal2(const int k, const int j, const int il,
                                  const int iu, const AthenaArray<Real> &cons,
                                  const AthenaArray<Real> &bbx,
                                  AthenaArray<Real> &flux,
                                  AthenaArray<Real> &ey,
...
void Schwarzschild::FluxToGlobal3(const int k, const int j, const int il,
                                  const int iu, const AthenaArray<Real> &cons,
                                  const AthenaArray<Real> &bbx,
                                  AthenaArray<Real> &flux,
                                  AthenaArray<Real> &ey,
...
void Schwarzschild::RaiseVectorCell(Real a_0, Real a_1, Real a_2, Real a_3,
                                    int k, int j, int i, Real *pa0, Real *pa1,
                                    Real *pa2, Real *pa3) {
  // Extract geometric quantities
  const Real &sin_sq_theta = metric_cell_j1_(j);
  const Real &alpha_sq = metric_cell_i1_(i);
...
void Schwarzschild::LowerVectorCell(Real a0, Real a1, Real a2, Real a3, int k,
