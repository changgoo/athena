...
// TODO(felker): change "MeshBlock *pmb" to reference member, set in initializer
// list
Gravity::Gravity(MeshBlock *pmb, ParameterInput *pin)
  ...
  // using Gravity as an example of: containing full object members instead of
  // pointer memebers, construting BoundaryVariaable composite obj (no default
  // ctor) in Gravity ctor initializer list, avoiding dynamically-managed memory
  // and the need for a user-provided dtor.
