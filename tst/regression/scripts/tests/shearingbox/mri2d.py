...
def prepare(**kwargs):
    ...
    athena.configure("b", prob="hb3", flux="hlld", eos="isothermal", **kwargs)
    athena.make()
...
def run(**kwargs):
    arguments = [
        ...
        "problem/ipert=1",
        "problem/ifield=1",
        "orbital_advection/Omega0=1.0e-3",
        "orbital_advection/qshear=1.5",
        "orbital_advection/shboxcoord=2",
        "time/ncycle_out=0",
    ]
