...
def prepare(*args, **kwargs):
    athena.configure('cr', 'hdf5', 'b', *args,
                     prob='cr_shear',
                     coord='cartesian',
                     **kwargs)
    athena.make()
...
def run(**kwargs):
    ...
    arguments = ['mesh/nx1=512', 'mesh/ix1_bc=shear_periodic',
                 'mesh/ox1_bc=shear_periodic', 'mesh/nx2=128',
                 'mesh/ix2_bc=periodic', 'mesh/ox2_bc=periodic',
                 'meshblock/nx1=512', 'meshblock/nx2=128', 'time/tlim=0.1',
                 'cr/vmax=200', 'cr/sigma=10', 'orbital_advection/Omega0=0.2',
                 'orbital_advection/qshear=1', 'problem/direction=0',
                 'problem/B0=1', 'problem/offset1=0.5', 'problem/cells=8']
