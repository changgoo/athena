...
def run(**kwargs):
    ...
    arguments = ['mesh/nx1=256', 'mesh/ix1_bc=shear_periodic',
                 'mesh/ox1_bc=shear_periodic', 'mesh/nx2=64',
                 'mesh/ix2_bc=periodic', 'mesh/ox2_bc=periodic',
                 'meshblock/nx1=256', 'meshblock/nx2=64', 'time/tlim=0.02',
                 'cr/vmax=200', 'cr/sigma=10', 'orbital_advection/Omega0=0.5',
