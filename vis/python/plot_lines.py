...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "data_files",
        help=(
            "comma-separated list of input files; empty strings repeat previous entries; "
    ...
    parser.add_argument(
        "x_names",
        help=(
            "comma-separated list of abscissas; empty strings repeat previous entries; "
    ...
    parser.add_argument(
        "y_names",
        help=(
            "comma-separated list of ordinates; empty strings repeat previous entries; "
    ...
    parser.add_argument(
        "output_file",
        help=(
            'name of output to be (over)written; use "show" to show interactive plot '
            "instead"
        ),
    )
    parser.add_argument(
        ...
        default="-",
        help=(
            'comma-separated list of line or marker styles, such as "-" or "o"; use the '
    ...
    parser.add_argument(
        ...
        "--colors",
        help=(
            'comma-separated list of color codes, such as "k", "blue", or "#123abc"; '
    ...
    parser.add_argument(
        ...
        "--labels",
        help=(
            "comma-separated list of labels for legend; empty strings are not added to "
    ...
    parser.add_argument("--x_min", type=float, help="minimum for x-axis")
    parser.add_argument("--x_max", type=float, help="maximum for x-axis")
    parser.add_argument("--y_min", type=float, help="minimum for y-axis")
    parser.add_argument("--y_max", type=float, help="maximum for y-axis")
    parser.add_argument("--x_label", help="label to use for x-axis")
    parser.add_argument("--y_label", help="label to use for y-axis")
